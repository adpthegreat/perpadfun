...
export const X_HANDLE: string = env.VITE_PERPSPAD_X_HANDLE ?? "perpspad";
export const X_TWEET_ID: string = env.VITE_PERPSPAD_X_TWEET_ID ?? "";
export const TG_BOT_USERNAME: string = env.VITE_TELEGRAM_BOT_USERNAME ?? "perpspad_quest_bot";
export const TG_CHANNEL_URL: string = env.VITE_TELEGRAM_CHANNEL_URL ?? "https://t.me/perpspad";
