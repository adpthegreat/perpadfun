      ...
      <article className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="prose-content mt-10 space-y-8 text-[15px] leading-relaxed text-foreground/90">
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              At launch you pick the underlying market and the leverage. Imperial currently covers 50+ markets across crypto majors, Sol-eco / DeFi, memes, US stocks (TSLA, NVDA, AAPL, AMD, AMZN, SPY), commodities (XAU, XAG, WTI, NATGAS, COPPER), and major FX pairs.
            </p>
            <p className="mt-3 text-muted-foreground">
