...
ALTER TABLE public.tokens
  ADD COLUMN IF NOT EXISTS source TEXT NOT NULL DEFAULT 'perpad',
...
--    (perpad-source insert rule already requires auth.uid() = creator_id and stays in force)
